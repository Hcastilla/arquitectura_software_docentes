...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sass_app_sass__ = __webpack_require__(10);
...
new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
  ...
  mounted() {
    const self = this;
    __WEBPACK_IMPORTED_MODULE_2_axios__["get"]('/curso/all').then(data => {
      self.clases = data.data;
      self.getStorageClase();
    });
    __WEBPACK_IMPORTED_MODULE_2_axios__["get"]('/estudiante/all').then(data => {
